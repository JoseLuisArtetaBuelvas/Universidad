...
<head>
    ...
    <title>Recuperar Contraseña - Sistema Universidad</title>
    <style>
        * {
...
<body>
    <div class="card">
        <div class="header">
            ...
            <p>Ingresa tu ID y correo electrónico registrado para recuperar tus credenciales.</p>
        </div>
        ...
        <form action="${pageContext.request.contextPath}/usuario" method="post">
            ...
            <div class="form-group">
                <label for="id">Identificación / ID del Usuario:</label>
